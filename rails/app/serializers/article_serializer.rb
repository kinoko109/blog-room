class ArticleSerializer < ActiveModel::Serializer
  ...
  # Articleに対応する親レコードのであるuserレコードもレスポンスに返す
  belongs_to :user, serializer: UserSerializer

  def created_at
    # serializer内でobjectを呼び出すと、レスポンスされるレコード自身が呼び出され、object.created_atは、article.created_atと読み替えることができる。
